...
<p> 1. - 🍔 Foodiess React Website (https://foodiess-react-web.netlify.app/) </p>
 <p align="right"> Technology Use - (React, Tailwind, NodeJs, Css) </p> 
<p> 2. - 🌦️ Weather API App (https://satyabratdivedi.github.io/Weather-API-App/) </p>
 <p align="right"> Technology Use - (HTML, CSS, JavaScript, APIs) </p> 
<p> 3. - 🍽️ Restaurant (https://satyabratdivedi.github.io/Restro-Web-New/)</p> 
<p> 4.- 💹 Marketing (https://satyabratdivedi.github.io/unability/) </p>
 <p align="right"> Technology Use - (HTML, SCSS, CSS, Bootstrap) </p> 
  <hr></hr>
